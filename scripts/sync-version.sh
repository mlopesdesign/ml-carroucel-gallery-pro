...
PLUGIN_FILE="$ROOT/ml-carousel-gallery-pro/ml-carousel-gallery-pro.php"
README_FILE="$ROOT/ml-carousel-gallery-pro/readme.txt"
...
const=$(grep -E "define\(\s*'MLCGP_VERSION'" "$PLUGIN_FILE" | head -1 | sed -E "s/.*'MLCGP_VERSION',\s*'([0-9.]+)'.*/\1/")
